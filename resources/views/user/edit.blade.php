...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-orange text-white">Gegevens Wijzigen</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update', Auth::id()) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="zipcode" type="text" class="form-control @error('zipcode') is-invalid @enderror" name="zipcode" value="{{ Auth::user()->zipcode }}" required autocomplete="zipcode">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('city') is-invalid @enderror" name="phone" value="{{ Auth::user()->phone }}" required autocomplete="phone">
